        ...
        <div class="row">
            <div class="ibox">
                <div class="ibox-content">
                    <form id="new_application_form" method="POST" action="/transferCourses/newApplication" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="univName" name="univName" placeholder="Full Name of University" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="courseCode" name="courseCode" placeholder="e.g. ECON102" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="courseName">Course Title</label>
                                            <input type="text" class="form-control" id="courseName" name="courseName" placeholder="e.g. Principle of Microeconomics" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-b-xs">
                            <div class="col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="appType">Application Type</label>:<br>New for submitting a new course to review; Renew for updating an existing course when it is about to expire.<br>
                                            <select class="m-t-sm selectpicker form-control" id="appType" name="appType" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" style="border: 0;" id="tcaf" name="tcaf" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label for="syllabus">Course Syllabus</label> in <b>PDF</b> format
                                            <input type="file" class="form-control" style="border: 0;" id="syllabus" name="syllabus" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <ul>
                                            <li>
                                                Please fill the Transfer Credit Approval Form ("Transfer Credit Approval Form (TCAF) (1)" on
                                                <a href="http://ji.sjtu.edu.cn/equivalence/index">Course Equivalencies</a>)
                                                and submit it in <span style="color:red">PDF</span> format.
                                            </li>
                                            <li>
                                                Please submit additional materials only in a <span style="color:red">.zip</span> package.
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <label for="appComment">Additional Explanation</label>
                        ...
                        <div class="m-t-md">
                            ...
                            Only for courses which are intended to be transferred back to substitute one of the JI existing courses.
                        </div>
