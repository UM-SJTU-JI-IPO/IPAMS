...
CREATE TABLE `transfer_applications` (
  ...
  `applicationFormFile` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `additionalMaterialFile` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
-- Dump completed on 2018-05-31 23:43:59
